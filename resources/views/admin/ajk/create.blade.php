    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Tambah Ahli Jawatankuasa</h2>
                
                {{-- button kembali ke route admin.ajk.index --}}
            </div>
            {{-- form input ajk details [gambar, nama ajk, jawatan, no. telefon] --}}
            <form action="{{ route('admin.ajk.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
