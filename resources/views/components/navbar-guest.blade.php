<nav class="bg-linear-to-r from-white to-gray-50 shadow-lg border-b border-gray-200 px-4 sm:px-6 py-4" x-data="{ open: false, dropdownOpen: false }">
  <div class="flex flex-wrap md:flex-nowrap items-center justify-between gap-4 mx-auto w-full max-w-7xl">
    <!-- Logo -->
    ...
    <div class="hidden md:flex items-center justify-center space-x-6 lg:space-x-8 font-medium flex-1">
